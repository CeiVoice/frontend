    ...
    return (
        <div ref={setReportRef} className={containerClasses}>
            <div className={`w-full h-full ${contentPadding} bg-transparent`}>
                ...
                <form onSubmit={handleSubmit} className='mt-4 p-8 rounded-3xl bg-gray-50 shadow-none border-none'>
                    ...
                    <textarea
                        ...
                        required
                    />
                    <button type="submit" className='mt-5 px-6 h-10 bg-[#4377E5] text-white rounded-lg pointer-fine:hover:bg-blue-700 cursor-pointer'>Submit</button>
                </form>
            </div>
        </div>
    )
